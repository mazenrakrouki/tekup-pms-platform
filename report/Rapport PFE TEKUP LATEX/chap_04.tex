...
generative design tool in which a screen is described in a sentence and the tool returns a plausible
layout. They served one purpose: to make the problem concrete. Reading a backlog of twenty-five user
stories tells you what the platform must do; looking at a screen tells you how much information a
single person is expected to hold at once, and whether four different audiences really need four

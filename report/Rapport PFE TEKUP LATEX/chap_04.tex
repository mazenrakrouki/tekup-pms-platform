...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_login.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_portfolio.png}
  \caption{Design sketch --- portfolio overview}
  \label{fig:mk-portfolio}
\end{figure}

\subsubsection{Sketches of a single project}
Two further sketches explored what one project looks like from the inside, on its financial side and
on its workload side.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_financial.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_workload.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_billing.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_developer.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.86\columnwidth]{img/mk_admin.png}

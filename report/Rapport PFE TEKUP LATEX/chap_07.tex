...
security review, and a reproducible deployment. It gathers two sprints: Sprint~9 consolidates the interface and
verifies the platform, Sprint~10 makes it reproducibly deployable and continuously verified.
Neither delivers new business functionality; both deliver deliverability.

% =====================================================================
\section{Sprint 9 --- Interface Consolidation, Testing and Deployment}
...
provisioned PostgreSQL instance are already present. Sprint~10 removes that assumption.
...
depends on a correctly prepared host. Sprint~10 closes that gap with containerization and a

...
it. These choices are made once here and are then applied uniformly by the nine sprints of
Chapters~4 to~7.
...
\begin{figure}[H]
  ...
  \caption{Domain overview --- entities grouped by sub-domain}
  \label{fig:class-global}
\end{figure}

Each sub-domain is detailed by its own class diagram, presented in the sprint that builds it:
security in Sprint~2 (Figure~\ref{fig:class-sec}), projects and teams in Sprint~3, workload and
indicators in Sprint~7, financial management in Sprint~5 and governance in Sprint~6.

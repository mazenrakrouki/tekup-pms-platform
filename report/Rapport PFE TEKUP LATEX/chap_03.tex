...
The platform rests on three principal technologies, one per tier: Spring Boot for the application
server, Angular for the single-page client, and PostgreSQL for persistence. Table~\ref{tab:stack}
details the complete environment.

\begin{figure}[H]
  \centering
  \begin{tabular}{@{\hspace{4mm}}c@{\hspace{16mm}}c@{\hspace{16mm}}c@{\hspace{4mm}}}
    \includegraphics[height=1.35cm]{img/logo_springboot.png} &
    \includegraphics[height=1.05cm]{img/logo_angular.png} &
    \includegraphics[height=1.35cm]{img/logo_postgresql.png} \\
  \end{tabular}
  \caption{Core technologies of the platform}
  \label{fig:stack-logos}
\end{figure}

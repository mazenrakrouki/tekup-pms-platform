 ...
 *
 * <p>M-6 : {@link #accessibleProjectIds(String)} émet une seule requête SQL (EXISTS subquery)
 * au lieu des trois requêtes originales (user lookup + chef-projects + assignments).
 */
@Service
